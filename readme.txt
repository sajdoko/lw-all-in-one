...
LocalWeb All In One should be installed only on websites created by LocalWeb S.R.L, because it extends certain functionalities of the website which may send certain data to LocalWeb's servers. This is to make possible showing data on LocalWeb App.

> Note: The plugin uses services from [LocalWeb](https://localweb.it/ "Web Marketing Agency") and is intended ONLY for LocalWeb S.R.L clients.
